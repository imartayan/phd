...
However, most SPSS representations such as simplitigs [@rahman2021representation; @simplitigs], matchtigs [@matchtigs], eulertigs [@eulertigs], and masked superstrings [@masked-superstring-kmer] are defined globally from a complete /kmer set.
...
To complicate matters, buckets are known to have skewed size distributions, as lower minimizers tend to gather more /kmers than others leading to expensive search for a large number of /kmers [@unitigs; @kmc2; @marchet2023scalable].
