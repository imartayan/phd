# Proofs and experiments on fractional hitting sets {#sec-appendix-skmer-sketch}
...
## Proof of @thm-density {#sec-proof-thm-density}
...
## Proof of @thm-density-sub {#sec-proof-thm-density-sub}
...
## Proof of @thm-max-skmers {#sec-proof-thm-max-skmers}
...
## Proof of @thm-density-uhs {#sec-proof-thm-density-uhs}
...
![Space cost in bits per /kmer according to the subsampling rate.](../fig/fhs/16_bitperkmeraccordingtok.png){#fig-bitperkmervssubsampling width=70%}

:::{#fig-ressalmok31 layout-nrow=3}
![](../fig/fhs/17_RAM_salmonelle1k_k31){width=70%}

![](../fig/fhs/18_TIME_salmonelle1k_k31){width=70%}

![](../fig/fhs/19_SIZE_salmonelle1k_k31){width=70%}

Salmonellas 1K k=31
:::

:::{#fig-resRefseqk63 layout-nrow=3}
![](../fig/fhs/20_RAM_refseq1k_k63-1){width=70%}

![](../fig/fhs/21_TIME_refseq1k_k63-1){width=70%}

![](../fig/fhs/22_SIZE_refseq1k_k63-1){width=70%}

Refseq 1K k=63
:::

:::{#fig-ressalmok63 layout="[[70],[70],[70]]"}
![](../fig/fhs/23_RAM_salmonelle1k_k63){width=70%}

![](../fig/fhs/24_TIME_salmonelle1k_k63){width=70%}

![](../fig/fhs/30_SIZE_salmonelle1k_k63){width=70%}
